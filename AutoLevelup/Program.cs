...
namespace AutoLevelup
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            else if (Player.BaseSkinName == "Fizz") abilitySequence = new int[] { 3, 1, 2, 3, 3, 4, 3, 1, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
            ...
            else if (Player.BaseSkinName == "Kalista") abilitySequence = new int[] { 2, 3, 1, 3, 3, 4, 1, 3, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
